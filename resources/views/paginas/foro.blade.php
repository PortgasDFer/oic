    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav m-auto">
          ...
          <li class="nav-item active"><a href="/foro" class="nav-link">foro</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            ...
            <h1 class="mb-0 bread">¡Únete a nuestro foro!</h1>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-center pb-5 mb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2>¡ÚNETE a nuestro FORO!</h2>
            <span class="subheading">Te invitamos a narrar en este espacio el problema que aqueje a tu vida: incomprensión familiar, divorcio, no encuentras trabajo, no tienes un espacio propio, etcétera</span>
          </div>
        </div>
              ...
              <div class="row no-gutters">
                <div class="col-lg-12 col-md-12 order-md-last d-flex align-items-stretch">
                  <div class="contact-wrap w-100 p-md-5 p-4">
                    <h3 class="mb-4">Registrate para ingresar al foro <small>Si ya estás registrado accede haciendo<a href="/forums"><strong> clic aquí</strong></a></small></h3>
                    <form method="POST" id="contactForm" name="contactForm" class="contactForm" action="{{ route('register') }}">
                      @csrf
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="label" for="name">Nombre Completo</label>
                            <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name') }}" autocomplete="name"placeholder="Nombre Completo">
                            @error('name')
                        ...
                        <div class="col-md-6"> 
                          <div class="form-group">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email') }}" autocomplete="email" placeholder="Email">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-6"> 
                          <div class="form-group">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror" name="password" id="password" autocomplete="new-password" placeholder="Contraseña">
                            @error('password')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="label" for="#">Mi historia</label>
                            <textarea name="message" id="message" class="form-control @error('message') is-invalid @enderror" cols="30" rows="4" placeholder="Cuentame tu historia" autocomplete="message" > </textarea>                           
                            @error('message')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
        ...
        <div class="row justify-content-center">
          <div class="col-md-12">
            <div class="text-resaltado text-center">
              Este espacio es la oportunidad de ser escuchad@, además, te daré un descuento del 40% en Coaching uno a uno toda vez que has enviado tu narrativa. <br><br>
              <img src="site/images/foro.jpg" class="img-fluid">
            </div>
          </div>
        </div>
      </div>
