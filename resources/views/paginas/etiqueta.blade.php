      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="/publicaciones">Temas de Interés<i class="ion-ios-arrow-forward"></i></a></span> <span> <i class="ion-ios-arrow-forward"></i></span></p>
            ...
            <div class="sidebar-box">
              <form method="POST" action="/busqueda" class="searchform order-sm-start order-lg-last">
                ...
                <div class="form-group d-flex">
                  <input type="text" class="form-control pl-3" name="palabra" placeholder="Escriba una palabra y 'Enter'" style="font-size:100;">
