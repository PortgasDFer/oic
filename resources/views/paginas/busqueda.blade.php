      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-end">
          <div class="col-md-9 ftco-animate pb-5">
            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="/">Inicio <i class="ion-ios-arrow-forward"></i></a></span> <span class="mr-2"><a href="/publicaciones">Temas de Interés<i class="ion-ios-arrow-forward"></i></a></p>
            <h1 class="mb-0 bread">{{$palabra}}</h1>
          </div>
        </div>
      </div>
    </section>
